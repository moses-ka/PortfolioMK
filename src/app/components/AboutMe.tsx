  ...
  return (
    ...
    >
      <div className="flex flex-row justify-center md:justify-start items-center w-full">
        <p className="w-full md:w-6/6 text-sm md:text-3xl p-4 md:p-10 glitch-container leading-8">
          ...
          Web Design and Development are not just professions for me; <br /> they are my <span className="glitch-text text-blue-400 effect-2" data-text="canvas."> canvas </span> where <span className="glitch-text effect-1" data-text="colors"> colors </span> meet <span className="glitch-text effect-2" data-text="code,"> code, </span> blending functionality with aesthetics. <br />
